      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
               {modules.map((main, _index) => (
                <SidebarLinkGroup activecondition={false} key={_index}>
                {(handleClick, open) => {
                  ...
                  return (
                    <React.Fragment>
                      ...
                      {main.children.map(module => (
                        <div className="lg:hidden lg:sidebar-expanded:block 2xl:block" key={module.name}>
                          <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                            <li className="mb-1 last:mb-0">
                              <NavLink
                                end
                                to={`/admin/${main.parentRoutes}/${module.routeProps.path}`}
                                className={({ isActive }) =>
