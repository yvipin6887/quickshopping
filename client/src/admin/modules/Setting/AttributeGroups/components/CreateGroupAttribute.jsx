        ...
        <>
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="max-w-md mb-6">
                    <label htmlFor="code" className="block mb-2 text-sm text-left font-medium text-gray-900 dark:text-white">Lable</label>
                    <input type="text" className="w-full bg-white-50 border border-gray-300" {...register("label", {required: true, maxLength: 80})} />
                    {/* {errors.code && <p>{errors.code.message}</p>} */}
                </div>
                <div className="max-w-md mb-6">
                    <label htmlFor="code" className="block mb-2 text-sm text-left font-medium text-gray-900 dark:text-white">Code</label>
